...
- V1 원본 보존본: `/Users/han-yejin/Documents/네온 게임`
  - `main` 커밋 `58d0c4a`
  - V1 빌드 검증 완료
- V2 작업본: `/Users/han-yejin/Documents/영점손해사정`
  - 현재 작업본은 원본 게임과 분리된 별도 저장소에서 관리

두 폴더는 별도 Git 작업 디렉터리다. V2 변경은 원본 보존본에 반영하지 않는다.
